...
$i_part = GUICtrlCreateInput("0", 80, 72, 40, 21)
$b_partMin = GUICtrlCreateButton("<", 55, 72, 21, 21)
$b_partPlus = GUICtrlCreateButton(">", 124, 72, 21, 21)
$i_bit = GUICtrlCreateInput("0", 80, 104, 40, 21)
$b_bitMin = GUICtrlCreateButton("<", 55, 104, 21, 21)
$b_bitPlus = GUICtrlCreateButton(">", 124, 104, 21, 21)
$i_nibble = GUICtrlCreateInput("0", 80, 136, 40, 21)
$b_nibbleMin = GUICtrlCreateButton("<", 55, 136, 21, 21)
$b_nibblePlus = GUICtrlCreateButton(">", 124, 136, 21, 21)
...
GUICtrlCreateLabel("Segment", 20, 40, 46, 17)
GUICtrlCreateLabel("Occ.", 130, 40, 35, 17)
GUICtrlCreateLabel("Part", 20, 72, 23, 17)
GUICtrlCreateLabel("Bit", 20, 104, 16, 17)
GUICtrlCreateLabel("Nibble", 20, 136, 34, 17)
...
While 1
  ...
  Switch $nMsg
    ...
    Case $i_segment
      _parse()
    Case $b_partPlus
      GUICtrlSetData($i_part, GUICtrlRead($i_part) + 1)
      _parse()
    Case $b_partMin
      GUICtrlSetData($i_part, GUICtrlRead($i_part) - 1)
      _parse()
    Case $b_bitPlus
      GUICtrlSetData($i_bit, GUICtrlRead($i_bit) + 1)
      _parse()
    Case $b_bitMin
      GUICtrlSetData($i_bit, GUICtrlRead($i_bit) - 1)
      _parse()
    Case $b_nibblePlus
      GUICtrlSetData($i_nibble, GUICtrlRead($i_nibble) + 1)
      _parse()
    Case $b_nibbleMin
      GUICtrlSetData($i_nibble, GUICtrlRead($i_nibble) - 1)
      _parse()
