			...
			If $recv <> "" Then
				...
				If $ConnectedSocket > -1 Then
					...
					If StringInStr($recv, "help", "", 1) Then
						$returnFile = "help.txt"
					ElseIF StringInStr($revc, "QRY^R01", "", 1) Then
						InetGet ("http://mhp:mhp@localhost:591/FMPro?-db=Pat.fp5&-format=QRY^R)1&-lay=SQL&PATidnum="& $PatID &"&-max=1&-find", @scriptdir &"\temp.txt", 1 )
						$returnFile =
					Else
