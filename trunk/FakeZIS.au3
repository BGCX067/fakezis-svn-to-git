...
#AutoIt3Wrapper_outfile=FakeZIS_v3.1.exe
...
;==============================================
Dim $GOOEY = GUICreate("FakeZIS v3.1 - for extreme HL7 developers", 500, 670)
		...
		While 1
			...
			If $recv <> "" Then
				...
				If $ConnectedSocket > -1 Then
					...
					DIM $coded = _WinAPI_WideCharToMultiByte(($reply & $closechars), "UTF-8" )

					$ret = TCPSend($ConnectedSocket, $coded )
